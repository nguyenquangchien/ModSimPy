...
% Bản tiếng Việt 2020-2023: Nguyễn Quang Chiến 
...
\index{khoa học: science}
\index{cơ học: mechanics}
...
\index{cài đặt Python: installation}
...
\index{người đóng góp: contributors}
...
\index{mô hình: model}
\index{trừu tượng hoá: abstraction}
\index{giải tích: anaylsis}
...
\index{dự đoán: prediction}
\index{giải thích: explanation}
\index{thiết kế: design}
...
\index{mô hình hoá lặp: iterative modeling}
...
\index{chủ nghĩa hiện thực: realism}
...
\index{tính đơn giản: simplicity}
...
\index{Newton}
\index{thuyết tương đối: theory of relavitly}
...
\index{kiểm định bên trong: internal validation}
\index{kiểm định bên ngoài: external validation}
...
\index{toà nhà Empire State Building}
\index{đồng xu: penny}
\index{chuyện hoang đường: myth}
...
\index{trường Wellesley College}
\index{trường Olin College}

Coi rằng hệ thống có 12 xe đạp và hai dãy xe, một ở Olin và một ở Wellesley, mỗi dãy chứa được 12 xe.

\index{hệ thống dùng chung xe: bike sharing system}
...
\index{import - câu lệnh: statement}
...
\index{biến trạng thái: state variable}
...
\index{dấu chấm - toán tử: operator}
\index{toán tử: operator!dấu chấm: dot}
...
\index{cập nhật - toán tử: operator}
\index{toán tử: operator!cập nhật: update}
...
\index{hàm: function}
\index{định nghĩa hàm: function definition}
...
{\bf khối lệnh}.
\index{def}
\index{khối lệnh: code block}
\index{thân: body}
\index{thụt đầu dòng: indentation}
...
\index{đối số: argument}
\index{cặp ngoặc tròn: parentheses}
...
\index{print - câu lệnh: statement}
\index{câu lệnh: statement!print}
...
\index{if - câu lệnh: statement}
\index{câu lệnh: statement!if}
...
\index{khái quát hóa: generalization}
...
\index{modsim - thư viện: library}
\index{TimeSeries: chuỗi thời gian}
\index{chuỗi thời gian: time series}
...
\index{lặp: loop}
\index{biến lặp: loop variable}
\index{mốc thời gian: time stamp}
...
\index{đối số từ khóa: keyword argument}
\index{đối số vị trí: positional argument}
\index{đối số: argument}
...
\index{Pyplot}
\index{đồ thị: plot}
\index{đồ thị: plotting}
\index{trang trí: decorate}
...
\index{dùng chung xe: bike share}
...
\index{mô hình hóa lặp: iterative modeling}
...
\index{tài liệu chú thích mã lệnh: documentation}
\index{docstring}
\index{chú thích: comment}
...
\index{chất lượng mã lệnh: code quality}
...
\index{return - câu lệnh: statement}
...
\index{cân bằng: equal}
\index{gán - toán tử: operator}
\index{toán tử!gán: assignment}
...
\index{cú pháp - lỗi: error}
\index{lỗi!cú pháp: syntax}

Toán tử bằng là một trong số các {\bf toán tử so sánh}. Các toán tử khác bao gồm:

\index{so sánh - toán tử: operator}
\index{toán tử!so sánh: comarison}
...
\index{ngẫu nhiên: deterministic}
\index{tất định: stochastic}
...
\index{giá trị trả lại: return value}
...
\index{tham số!của mô hình: model}
\index{tham số!của hàm: function}
...
\index{vòng lặp: loop}
\index{vòng lặp!biến: variable}
\index{biến!vòng lặp: loop}
...
\index{kịch bản nếu-thì: what-if scenario}
...
\index{gỡ lỗi: debug}
\index{phát triển tăng dần: incremental development}
...
\index{điều chỉnh kiểm tra được: testable change}
...
\index{Erlich, Paul}
\index{Quả bom dân số: Population Bomb}
...
\index{thế giới - dân số: world population}
\index{dân số: population}
...
\index{Bảo tàng lịch sử quốc gia Mỹ: American Museum of Natural History}
...
\index{dấu ngoặc vuông (toán tử: operator)}
\index{toán tử!dấu ngoặc vuông: bracket}
...
\index{Liên hợp quốc: United Nations}
...
\index{ngoặc vuông (toán tử): bracket}
...
\index{viết mã cứng: hard-coding}
...
\index{vòng lặp: loop}
\index{biến vòng lặp: loop variable}
...
\index{vẽ đồ thị: plotting}
\index{trang trí: decoration}
...
\index{tăng trưởng dân số: population growth}
...
\index{tăng trưởng bậc hai: quadratic growth}
...
\index{goodness-of-fit: mức độ khớp}
\index{số liệu: data}
\index{data fitting: khớp số liệu}
...
\index{parameterize: tham số hóa}
...
\index{sức chứa dân cư: carrying capacity}
...
Có những năm mà một cơ quan nào đó không công bố một kết quả dự phóng, vì vậy vài phần tử trong  \py{table3} chứa giá trị đặc biệt \py{NaN}, viết tắt từ ``not a number" (không phải một trị số).  \py{NaN} thường được dùng để biểu diễn dữ liệu khuyết thiếu.

\index{không phải trị số: not a number}
\index{NaN}
\index{dữ liệu khuyết thiếu: missing data}
...
\index{nhân khẩu học: demography}
...
\index{liên hệ lặp lại: recurrence relation}
...
\index{cấp số nhân: geometric progression}
\index{tăng trưởng bậc hai: quadratic growth}
...
\index{rời rạc: discrete}
\index{liên tục: continuous}
\index{bước thời gian: time step}
...
\index{phương trình vi phân: differential equation}
...
\index{loga}
\index{hàm mũ: exponential}
\index{tích phân: integrate}
...
\index{giải tích: analysis}
\index{đại số: algebra}
\index{phép toán với kí hiệu: symbolic manipulation}
...
\index{kí hiệu toán học: mathematical notation}
\index{ngôn ngữ lập trình: programming language}
...
\index{tính toán kí hiệu: symbolic computing}
\index{WolframAlpha}
...
\index{nghiệm tổng quát: general solution}
\index{nghiệm riêng: specific solution}
...
\index{tăng trưởng cấp số nhân: exponential growth}
...
\index{tăng trưởng bậc hai: quadratic growth}
\index{hàm lôgit: logistic function}
...
\index{tăng trưởng tuyến tính: linear growth}
\index{tăng trưởng cấp số nhân: exponential growth}
\index{tăng trưởng logit: logistic growth}
...
\begin{figure}
\centerline{\includegraphics[height=3in]{figs/dataframe.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=5.5in]{figs/queue.pdf}}
...
\index{Olin College}
\index{bệnh dịch tân sinh viên: Freshman Plague}
...
\index{tốc độ hồi phục: recovery rate}
...
\index{tốc độ lây nhiễm: infection rate}
...
\index{dễ tổn thương: susceptible}
...
\index{kho: stock}
\index{luồng: flow}
\index{biểu đồ kho và luồng: stock and flow diagram}
...
\index{thực hiện: implementation}
...
\begin{python}
tc = 3             # thoi gian giua cac tiep xuc, tinh theo ngay
tr = 4             # thoi gian hoi phuc tinh theo ngay
\end{python}

Ta có thể dùng chúng để tính ra các tham số mô hình:

\begin{python}
beta = 1 / tc      # toc do tiep xuc, moi ngay
gamma = 1 / tr     # toc do hoi phuc, moi ngay
\end{python}
...
\index{cập nhật (hàm): update}
\index{hàm!cập nhật: update}
\index{bước thời gian: time step}
...
\index{State (đối tượng: object)}
\index{biến trạng thái: state variable}
\index{biến cục bộ: local variable}
...
\index{TimeFrame (đối tượng: object)}
\index{DataFrame (đối tượng: object)}
...
\index{ngoặc vuông (toán tử: operator)}
\index{toán tử~ngoặc vuông: bracket}
...
\index{biến hệ thống: system variable}
...
\index{miễn dịch: immune}
\index{vắc-xin: vaccine}
...
\index{miễn dịch cộng đồng: herd immunity}
...
\index{logistic curve: đường cong logit}
...
\index{Kermack-McKendrick (mô hình: model)}
\index{SIR (mô hình: model)}
...
\index{SweepSeries (đối tượng: object)}
...
\index{SweepFrame, đối tượng: object}
\index{DataFrame, đối tượng: object}
...
\index{phi thứ nguyên: dimensionless}
...
\index{phi thứ nguyên hóa: nondimensionalization}
...
\index{hệ thống nhiệt: thermal system}
...
\index{coffee cooling problem: bài toán làm nguội cà-phê}
\index{Walker, Jearl}
...
%
Ta có thể giải phương trình này để tìm ra $T$:
%
...
\index{câu lệnh: statement!assert}
...
\index{hàm: function!kết quả trả lại: return value}
\index{Series}
...
\index{hàm: function!cập nhật: update}
...
\index{hàm: funciton!độ dốc: slope}
\index{tháo: unpack}
...
\index{hàm: function!sai số: error}
...
\index{mô hình insulin tối thiểu: insulin minimal model}
\index{phương trình vi phân: differential equation}
...
Đến giờ những phương trình vi phân mà ta đã xử lý đều thuộc dạng {\bf bậc nhất}, theo nghĩa là chúng chỉ chứa các đạo hàm bậc nhất thôi. Ở chương này, ta hãy hướng sự chú ý tới các phương trình vi phân bậc hai, vốn chứa cả đạo hàm bậc nhất lẫn bậc hai.

\index{phương trình vi phân bậc nhất: first order ODE}
\index{phương trình vi phân bậc hai: second order ODE}
...
Các phương trình vi phân bậc nhất có thể được viết thành
%
\[ \frac{dy}{dx} = G(x, y) \]
%
trong đó $G$ làm một hàm nào đó của $x$ và $y$ (xem \url{http://modsimpy.com/ode}).  Các phương trình vi phân bậc 2 có thể viết dưới dạng
%
\[ \frac{d^2y}{dx^2} = H(x, y, \frac{dy}{dt}) \]
%
trong đó $H$ là một hàm của $x$, $y$, và $dy/dx$.

Ở chương này, ta sẽ xử lý một trong những phương trình vi phân thông dụng nhất, đó là định luật Newton II về chuyển động:
%
\[ F = m a \]
%
trong đó $F$ là một lực hoặc hợp lực, $m$ là khối lượng của vật thể chuyển động, còn $a$ là gia tốc của nó.

\index{định luật Newton II về chuyển động: Newton’s second law of motion}
\index{phương trình vi phân: differential equation}
\index{gia tốc: acceleration}
\index{vận tốc: velocity}
\index{toạ độ: position}
...
\index{khối lượng biến đổi: variable mass}
...
\index{cơ học lượng tử: quantum mechanics}
...
\index{đồng xu rơi: falling penny}
\index{sức cản không khí: air resistance}
...
\index{độ dốc (hàm: function)}
\index{hàm: function!độ dốc: slope}
...
\index{hệ phương trình: system of equations}
\index{tháo}
...
Tham số đầu tiên, \py{state}, có chứa các toạ độ và vận tốc của đồng xu. Tham số sau cùng, \py{system}, lại chứa tham số hệ thống \py{g}, là độ lớn gia tốc trọng trường.
...
\py{results} trong một \py{TimeFrame} có hai cột: \py{y} chứa độ cao của đồng xu; \py{v} chứ vận tốc của nó.
...
\begin{figure}
\centerline{\includegraphics[height=2.5in]{figs/chap09-fig01.pdf}}
...
Giá trị trả lại là độ cao của đồng xu, \py{y}, sẽ giao cắt qua \py{0} khi đồng xu tiếp đất.
...
\index{sức cản không khí: air resistance}
\index{lực cản kéo: drag force}
\index{lực: force!cản: drag}
\index{phương trình lực cản: drag equation}
...
\index{diện tích tham chiếu: reference area}
...
\index{Mythbusters}
\index{vận tốc tiếp đất: terminal velocity}
...
\chapter{Đường bay trong không gian hai chiều}
\label{chap22}
...
\index{vector đơn vị: unit vector}
\index{hat (hàm: function)}
...
\index{đồ thị đường bay: trajectory plot}
...
\index{con quay hồi chuyển: gyroscope}
...
\index{giấy vệ sinh: toilet paper}
...
\index{vận tốc góc: angular velocity}
\index{phương trình vi phân: differential equation}
...
Đến đây ta đã có quy trì khá chuẩn về cách viết những mô phỏng kiểu thế này. Trước tiên, ta sẽ lấy các đơn vị cần thiết từ Pint:
\index{Pint}
...
Và rồi tạo một đối tượng \py{Params} chứa các tham số hệ thống:
...
\py{Rmin} và \py{Rmax} là những giá trị đầu và cuối của bán kính, \py{r}.  \py{L} là chiều dài toàn bộ cuộn giấy, còn \py{t_end} là tổng thời gian mô phỏng.

Khi đó ta có thể dùng đối tượng \py{Params} để lập một đối tượng \py{System}:
...
Trạng thái ban đầu có chứa 3 biến, đó là \py{theta}, \py{y}, và \py{r}.

\index{tháo: unpack}

Để bắt đầu, ta sẽ ước tính giá trị hợp lý cho \py{k}; rồi ở Mục~\ref{paper_analysis} ta sẽ hình dung ra giá trị chính xác hơn. Sau đây là cách ta thực hiện ước tính:
...
\py{Ravg} là bán kính trung bình, chính giữa \py{Rmin} và \py{Rmax}, do vậy \py{Cavg} là chu vi cuộn giấy khi \py{r} bằng \py{Ravg}.

\py{revs} là tổng số vòng quay cần để cuộn được một đoạn giấy dài \py{L} nếu \py{r} được coi là không đổi tại \py{Ravg}.  Và \py{rads} chỉ là \py{revs} quy đổi thành radian.

Sau cùng, \py{k} là mức biến đổi của \py{r} ứng với mỗi radian chuyển động quay. Với các tham số này, \py{k} bằng khoảng \py{2.8e-5} \si{\meter\per\radian}.

Bây giờ ta có thể dùng các phương trình vi phân từ Mục~\ref{paper} để viết ra một hàm độ dốc:
...
\begin{figure}[t]
\centerline{\includegraphics[height=5.5in]{figs/chap11-fig01.pdf}}
\caption{Kết quả mô phỏng cuốn giấy, thể hiện số vòng, độ dài và bán kính cuộn giấy theo thời gian.}
\label{chap11-fig01}
\end{figure}

Như thường lệ, hàm độ dốc nhận vào một đối tượng \py{State}, một thời gian và một đối tượng \py{System}. Đối tượng \py{State} có chứa các giá trị giả tưởng của \py{theta}, \py{y}, và \py{r} tại thời điểm \py{t}.  Nhiệm vụ của hàm độ dốc là để tính các đạo hàm theo thời gian của những giá trị này. Đạo hàm theo thời gian của \py{theta} là vận tốc góc, vốn thường được kí hiệu là \py{omega}.

\index{đối tượng State object}

Ta sẽ muốn dừng mô phỏng khi chiều dài cuộn giấy là \py{L}. Ta có thể làm vậy với một hàm sự kiện, hàm này cắt qua 0 khi \py{y} bằng \py{L}:
...
Hình~\ref{chap11-fig01} cho thấy kết quả.  \py{theta} tăng tuyến tính theo thời gian, như ta mong đợi. Két quả là \py{r} cũng tăng tuyến tính. Nhưng vì đạo hàm của \py{y} lại phụ thuộc vào \py{r}, mà \py{r} thì tăng, nên \py{y} cũng tăng với độ dốc ngày càng lớn dần.

Vì hệ thống này quá đơn giản nên sẽ thật ngớ ngẩn nếu dùng mô phỏng. Như ta sẽ thấy ở mục kế tiếp, có thể dễ dàng giải được phương trình vi phân bằng cách giải tích. Nhưng cũng cần bắt đầu bằng một mô phỏng đơn giản nhằm khám phá và kiểm tra các giả định.

Để việc mô phỏng thực hiện được, ta phải viết đúng đơn vị, bằng cách này sẽ giúp sớm phát hiện những lỗi về khái niệm. Và bằng cách đưa vào các tham số thực tế, ta có thể phát hiện những lỗi gây ra kết quả phi thực tế. Chẳng hạn, ở hệ thống này ta có thể kiểm tra rằng:

\begin{itemize}

\item Tổng thời gian mô phỏng là khoảng 2 phút, điều này hợp lý với thời gian cần để cuộn \SI{47}{\meter} giấy.

\item Giá trị cuối cùng của \py{theta} bằng khoảng \SI{1250}{\radian}, tương đương với khoảng 200 vòng cuộn, điều này cũng hợp lý.

\item Các giá trị đầu và cuối của \py{r} cũng nhất quán với \py{Rmin} và \py{Rmax}, như ta đã dự kiến khi chọn \py{k}.

\end{itemize}

Nhưng bây giờ khi đã có mô phỏng chạy được, việc tính toán bằng giải tích sẽ có ích.


\section{Giải tích}
\label{paper_analysis}

Các phương trình vi phân ở Mục~\ref{paper} đều đơn giản để có thể bắt tay vào giải ngay. Vì vận tốc góc là hằng số:
%
\[ \frac{d\theta}{dt} = \omega  \]
%
nên ta có thể tìm $\theta$ dưới dạng hàm thời gian bằng cách lấy tích phân cả hai vế:
%
\[ \theta(t) = \omega t + C_1 \]
%
Với điều kiện đầu $\theta(0)=0$,  ta được $C_1=0$.  Tương tự,
%
\begin{equation}
...
\[ r(t) = k \omega t + C_2 \]
%
Với điều kiện đầu $r(0)=R_{min}$,  ta tìm được $C_2=R_{min}$.  Khi đó ta có thể thế nghiệm cho $r$ vào phương trình của $y$:
%
\begin{align}
...
%
Như vậy $y$ là một đường parabol, như bạn đã đoán trước. Với điều kiện đầu $y(0)=0$, ta tìm được $C_3=0$.

\index{giải tích: analysis}
\index{tích phân: integral}

Ta cũng có thể dùng các phương trình này để tìm mối quan hệ giữa $y$ và $r$, độc lập theo thời gian, để từ đó có thể tính ra $k$.  Bằng một thao tác như đã thấy ở Mục~\ref{contact}, tôi sẽ lấy PT~\ref{eqn1} chia PT \ref{eqn2}, để thu được
%
\[ \frac{dr}{dy} = \frac{k}{r}\]
%
...
\[ r^2 / 2 = k y + C \]
%
Khi $y=0$, $r=R_{min}$, do vậy
%
\[ C = \frac{1}{2} R_{min}^2 \]
%
Giải để tìm $y$, ta được
%
\begin{equation}
y = \frac{1}{2k} (r^2 - R_{min}^2)                 \label{eqn3}
\end{equation}
%
Khi $y=L$, $r=R_{max}$; thay thế các giá trị này, ta được 
%
\[ L = \frac{1}{2k} (R_{max}^2 - R_{min}^2) \]
%
Giải để tìm $k$, ta được 
%
\begin{equation}
k =  \frac{1}{2L} (R_{max}^2 - R_{min}^2)           \label{eqn4}
\end{equation}
%
Thay các giá trị tham số vào, ta được \py{2.8e-5} \si{\meter\per\radian}, đúng bằng với trị số ``ước tính" như ở Mục~\ref{papersim}.  Trong trường hợp này, ước tính là hoàn toàn chính xác.

Ở chương tiếp theo, ta sẽ chạy mô phỏng bằng cách khác, tháo cuộn giấy.
...
Ở chương trước, ta đã mô hình hoá kịch bản với vận tốc góc là hằng số. Ở chương này ta sẽ giải bài toán phức tạp hơn: ta sẽ mô hình hoá một ấm trà đặt trên bàn xoay với gia tốc góc là hằng số.


\section{Gia tốc góc}

\index{gia tốc góc: angular acceleration}
\index{mô-men xoắn: torque}

Cũng như gia tốc dài là đạo hàm của vận tốc, thì {\bf gia tốc góc} là đạo hàm của vận tốc góc. Và cũng như gia tốc dài gây ra do lực, thì gia tốc góc gây bởi một dạng lực quay mà ta gọi là {\bf mô-men xoắn}.  Nếu chưa quen với mô-men xoắn, bạn có thể đọc thêm thông tin từ \url{http://modsimpy.com/torque}.
...
\index{khối lượng: mass}
\index{mô-men quán tính: moment of inertia}
...
Hình~\ref{teapot} cho thấy kịch bản này, trong đó $F$ là lực tác dụng vào bàn xoay ở chu vi của nó, lực này vuông góc với tay đòn, $r$, còn $\tau$ là mô-men xoắn hình thành. Vòng tròn màu xanh gần đáy là ấm trà.

Sau đây là đối tượng \py{Params} với những gía trị nêu trên
...
\py{make_system} tạo nên trạng thái ban đầu, \py{init}, rồi
tính toán tổng mô-men quán tính của bàn xoay cùng ấm trà.
...
\py{theta} biểu diễn góc ban đầu của bàn, theo \si{\radian}; \py{omega} biểu diễn vận tốc góc theo \si{\radian\per\second}.

\py{I_disk} là mô-men quán tính của bàn xoay, vốn dựa trên mô-men quán tính của đĩa đặt nằm ngang quay xung quanh một trục thẳng đứng qua tâm:
%
\[ I_{disk} = m r^2 / 2 \]
%
\py{I_pot} là mô-men quán tính của ấm trà, mà tôi coi nó là điểm khối lượng có:
%
\[ I_{point} = m r^2 \]
%
Bây giờ ta có thể lập đối tượng \py{System}:
...
Sau đây là độ dốc nhận vào vị trí hiện thời, vốn có chứa góc và vận tốc góc, rồi trả lại các đạo hàm là vận tốc góc và gia tốc góc:
...
\index{hàm độ dốc: slope function}

Trong kịch bản này, lực áp dụng lên bàn xoay luôn đặt vuông góc với tay đòn lực, bởi vậy $\sin \theta = 1$ và mô-men xoắn do lực này gây ra sẽ là $\tau = r F$.

Trong một mô hình chi tiết hơn, tôi có thể lượng hoá lực gây ra bởi ma sát và tay đòn tương ứng, song điều đó không thực sự cần thiết. Thay vì vậy, tôi sẽ chọn cách lượng hoá mo-men xoắn do ma sát mà lược bớt những chi tiết phức tạp.

\index{ma sát: friction}

Bây giờ ta đã sẵn sàng chạy mô phỏng rồi, song còn một vấn đề cần giải quyết nữa.

Khi tôi ngừng đẩy bàn xoay, gia tốc góc đột ngột thay đổi. 
Ta đã có thể lập trình hàm độ dốc bằng câu lệnh \py{if}
nhằm kiểm tra giá trị của \py{theta} và đặt 
\py{force} tương ứng. Đối với một mô hình đơn giản thế này,
như vậy có lẽ là đủ. Nhưng tôi sẽ nhận được kết quả chính xác hơn 
nếu như mô phỏng hệ thống qua hai giai đoạn:

\begin{enumerate}
\item
  Trong giai đoạn thứ nhất, lực bằng hằng số, và ta chạy tới tận khi
  \py{theta} bằng 0.5 radian.
\item
  Trong giai đoạn thứ hai, lực bằng 0, và ta chạy tới tận khi \py{omega}
  bằng 0.
\end{enumerate}

Sau đó ta có thể kết hợp các kết quả từ hai giai đoạn trên vào thành một
\py{TimeFrame} duy nhất.

\index{mô phỏng hai giai đoạn: two-stage simulation}

Sau đây là hàm sự kiện mà tôi sẽ dùng cho giai đoạn 1; nó dừng mô hponrg khi \py{theta} đạt tới \py{theta_end}, là lúc tôi ngừng đẩy bàn xoay:
...
Bây giờ ta có thể chạy giai đoạn thứ nhất.
...
Một lần nữa, tôi chỉ định \py{max_step} để kết quả trông có vẻ mượt hơn khi vẽ lên biểu đồ, đổi lại tôi phải tính kĩ hơn một chút.

\begin{figure}
\centerline{\includegraphics[height=5.0in]{figs/chap25-fig01.pdf}}
\caption{Góc và vận tốc góc của bàn xoay theo lực tác dụng và ma sát.}
\label{chap25-fig01}
\end{figure}

Trước khi chạy giai đoạn thứ hai, ta phải kết xuất thời điểm cuối và
trạng thái của giai đoạn một.
...
Bây giờ ta có thể lập một đối tượng \py{System} cho Giai đoạn 2, với trạng thái ban đầu lấy từ Giai đoạn 1, và với \py{force=0}.
...
Với giai đoạn hai, ta cần một hàm sự kiện để dừng tính toán khi bàn xoay dừng lại; đó là khi vận tốc góc bằng 0.
...
Bây giờ ta có thể chạy giai đoạn thứ hai.
...
Pandas cung cấp cho ta \py{combine_first}, hàm này giúp kết hợp
\py{results1} với \py{results2}.
...
Hình~\ref{chap25-fig01} cho thấy kết quả. Vận tốc góc \py{omega} tăng tuyến tính khi tôi đẩy bàn, và giảm tuyến tính khi tôi buông tay. Góc quay \py{theta} là tích phân của vận tốc góc, bởi vậy nó vạch nên một đường parabol trong từng giai đoạn.

Ở mục kết tiếp, ta sẽ dùng mô phỏng này để ước tính mô-men xoắn do ma sát.


\section{Ước tính ma sát}

Bây giờ hãy lấy mã lệnh từ mục trước rồi gói nó vào trong một hàm.
...
def run_two_phases(force, torque_friction, params):
    ...
    # lay trang thai cuoi tu Giai đoan 1
    t_0 = get_last_label(results1) * s
    theta, omega = get_last_value(results1)
    ...
    # ket hop va tra lai ket qua 
    results = results1.combine_first(results2)
    return results
\end{python}

Bây giờ ta có thể dùng \py{run_two_phases} để viết một hàm sai số mà ta có thể dùng, với \py{fsolve}, nhằm tìm ra mô-men xoắn do ma sát để cho ta kết quả quan sát thấy từ lần quay thứ nhất, với tổng góc quay là \SI{1.5}{\radian}.
...
Nhưng trước khi gọi \py{fsolve}, ta phải giải quyết một vấn đề. Nhằm hỗ trợ tính toán với các đơn vị, thư viện \py{modsim} đã dùng tới ít nhiều luật bất thành văn. Với hầu hết các đơn vị thì luật ngầm đó vẫn hiệu lực tốt, nhưng có những đơn vị như Newton thì chưa được chuẩn xác.

\index{\py{fsolve}}

Tuy vậy, bây giờ khi đã có trong tay mô phỏng chạy được rồi, và đã phần nào tin tưởng nó hoạt động đúng, thì sẽ không nhất thiết phải kè kè mang theo đơn vị trong quá trình tính toán nữa.

Lúc này ta có thể buông bỏ đơn vị bằng cách tạo ra đối tượng \py{Params} mới chứa cùng giá trị mà không có đơn vị. Thư viện \py{modsim} cung cấp \py{remove_unit}, chỉ để làm nhiệm vụ này.
...
Phần mã lệnh còn lại sẽ chạy được y nguyên không cần thay đổi, một phần lí do vì tôi đã thiết kế mã lệnh để giữ hầu hết đơn vị ở cùng một chỗ.

Bây giờ ta có thể dùng \py{fsolve} để ước tính mô-men xoắn do ma sát.
...
Kết quả bằng \SI{0.166}{\newton\meter}, nhỏ hơn đôi chút so với ước tính ban đầu.

Bây giờ khi đã biết mô-men xoắn do ma sát, ta có thể tính lực cần để đẩy bàn quay nốt góc còn lại, nghĩa là từ \SI{1.5}{\radian} đến \SI{3.14}{\radian}.

Ở cuốn tập lệnh cho chương này, \py{chap25.ipynb}, bạn sẽ có dịp hoàn thành bài tập này. Để biết về chỉ dẫn cách tải về và chạy mã lệnh, hãy xem Mục~\ref{code}.


\chapter{Nghiên cứu cụ thể}
\label{chap26}

\section{Công cụ tính toán}

Ở Chương~\ref{chap20} chúng ta đã viết một phương trình vi phân bậc 2 thành một hệ các phương trình bậc nhất, rồi giải chúng bằng một hàm độ dốc như sau:
...
Ta đã dùng hàm \py{crossings} để tìm kiếm các nghiệm phương trình kết quả mô phỏng.

Sau đó, ta đã dùng một hàm sự kiện như sau:
...
\noindent để dừng mô phỏng khi sự kiện xảy ra. Lưu ý rằng hàm sự kiện nhận cùng các tham số như hàm độ dốc.

Ở Chương~\ref{chap21} ta đã phát triển một mô hình sức cản không khí và dùng tới một đối tượng  \py{Params}, vốn là tập hợp các tham số:
...
Và ta thấy một cách khác để tạo nên đối tượng \py{System}, sao choép các biến từ đối tượng \py{Params} rồi bổ sung hoặc thay đổi các biến:
...
Ta cũng đã dùng hàm \py{gradient} để ước tính gia tốc khi cho trước vận tốc:

\begin{python}
a = gradient(results.v)
\end{python}

Chương~\ref{chap22} đã giới thiệu các đối tượng \py{Vector}, vốn có thể biểu diễn các đại lượng vec-tơ, như toạ độ, vận tốc, lực, và gia tốc, trong không gian 2 hoặc 3 chiều.

\begin{python}
A = Vector(3, 4) * m
\end{python}

Mã lệnh cũng giới thiệu biểu đồ quỹ đạo, cho thấy đường bay của vật thể trong không gian 2 chiều:

\begin{python}
plot(results.x, results.y, label='trajectory')
\end{python}

Ở Chương~\ref{chap23} ta định nghĩa một hàm tầm xa (range) để tính quãng đường mà quả bóng chày bay được như một hàm phụ thuộc góc ném:
...
Sau đó ta dùng \py{max_bounded} để tìm góc ném cho ta tầm xa cực đại:

\begin{python}
res = max_bounded(range_func, [0, 90], params)
\end{python}

Như vậy là bộ công cụ đã dựng xong. Các Chương~\ref{chap24} và~\ref{chap25} đã giới thiệu cơ chế vật lý của chuyển động quay, nhưng không kèm theo công cụ tính toán nào.


\section{Chi tiết bên trong}

Hàm \py{crossings} dùng đến \py{InterpolatedUnivariateSpline} của SciPy, lớp này cung cấp một hàm \py{roots} để tìm nghiệm. Nó sử dụng đường spline bậc ba để nội suy giữa các bước thời gian cho nghiệm của phương trình vi phân.

\index{crossings (hàm)}

Đối tượng \py{Params} giống hệt như đối tượng \py{System}, chỉ khác tên gọi thôi, và đều dựa trên kiểu \py{Series} của Pandas.  Đôi khi tôi thấy cần dùng đối tượng \py{Params} để tạo các đối tượng \py{System}, song điều này không cần thiết.

\index{Params}

Đối tượng \py{Vector} là một \py{Quantity}, như được định nghĩa bởi Pint, và do vậy nó thường có đơn vị.  Nó có chứa một mảng NumPy bao gồm các toạ độ.  Vậy là đa số các phép toán vec-tơ thực chất là phép toán với ma trận.

\index{Vector}

\py{max_bounded} dùng đến hàm \py{minimize_scalar} của SciPy, mà bản thân hàm này lại dùng phương pháp Brent. Bạn có thể đọc thêm thông tin ở \url{http://modsimpy.com/minimize}).

\index{\py{max_bounded}}
\index{SciPy}
\index{\py{minimize_scalar}}
\index{phương pháp Brent method}


\section{Lại xét bài toán nhảy bungee}

Ở Chương~\ref{chap21}, ta đã mô phỏng cách nhảy bungee với một mô hình có xét tới trọng trường, sức cản không khí, và lực đàn hồi của dây níu, nhưng ta bỏ qua trọng lượng của sợi dây này.

\index{bungee; nhảy: jump}
\index{bungee; dây níu: cord}

Thật dễ nhầm tưởng rằng sợi dây không có ảnh hưởng gì vì nó rơi theo người nhảy. Tuy nhiên, khi sợi dây rơi thì nó truyền năng lượng cho người.

Ở \url{http://modsimpy.com/bungee} bạn sẽ tìm thấy bài báo\footnote{Heck, Uylings, and Kędzierska, ``Understanding the physics of bungee jumping", Physics Education, Volume 45, Number 1, 2010.} giải thích hiện tượng này và rút ra biểu thức mô tả gia tốc người nhảy, $a$, dưới dạng hàm của toạ độ, $y$, cùng vận tốc, $v$:
%
\[ a = g + \frac{\mu v^2/2}{\mu(L+y) + 2L} \] 
%
trong đó $g$ là gia tốc trọng trường, $L$ là chiều dài sợi dây, còn $\mu$ là tỉ số giữa khối lượng sợi dây, $m$, và khối lượng người nhảy, $M$.

Nếu bạn không tin rằng mô hình của họ đúng, thì video này có thể thuyết phục bạn: \url{http://modsimpy.com/drop}.

Hãy điều chỉnh mã lệnh từ Chương~\ref{chap21} để mô hình hoá hiệu ứng này. Vậy động thái của hệ thống sẽ thay đổi ra sao khi ta thay đổi khối lượng dây? Khi khối lượng sợi dây bằng khối lượng người nhảy, hiệu ứng tổng thể tại điểm thấp nhất tỏng cú nhảy sẽ ra sao?


\section{Người nhện}

Trong trường hợp này, ta sẽ phát triển một mô hình biểu diễn sợi tơ 
từ Người nhện gắn với đỉnh toà nhà Empire State Building.  
Ban đầu, Người nhện ở đỉnh một toán nhà gần kề, như trên 
Hình~\ref{spiderman}.

\index{Người nhện: Spider-Man}
\index{Toà nhà Empire State Building}

\begin{figure}
\centerline{\includegraphics[height=2.8in]{figs/spiderman.pdf}}
\caption{Sơ đồ trạng thái ban đầu cho nghiên cứu trường hợp Người nhện.}
\label{spiderman}
\end{figure}

Gốc toạ độ, \texttt{O}, đặt tại chân toà nhà Empire State. 
Vec-tơ \py{H} biểu diễn vị trí  represents the position where the webbing is attached
to the building, relative to \py{O}. The vector \py{P} is the
position of Người nhện relative to \py{O}. And \py{L} is the
vector from the attachment point to Người nhện.

\index{vector}

Bằng cách dõi theo các mũi tên từ \py{O}, dọc theo \py{H}, và dọc theo
\py{L}, ta có thể thấy
...
Bởi vậy, ta có thể tính \py{L} như sau:

\begin{code}
L = P - H
\end{code}

Mục đích của nghiên cứu cụ thể này bao gồm:

\begin{enumerate}

\item
  Lập mô hình cho kịch bản này nhằm dự tính đường bay của Người nhện.
\index{đường bay: trajectory}

\item
  Chọn đúng thời điểm để Người nhện buông sợi tơ nhằm đạt tầm xa tối đa trước khi đáp xuống.
\index{tầm xa: range}

\item
  Chọn góc tối ưu để Người nhện nhảy khỏi toà nhà, và buông sợi tơ, để đạt tầm xa tối đa.
\index{tối ưu hoá: optimization}  
  
\end{enumerate}

Ta sẽ dùng đến những tham số sau:
\index{tham số: parameter}

\begin{enumerate}

\item Theo trang Wiki Người nhện \footnote{\url{http://modsimpy.com/spider}} thì Người nhện cân nặng \SI{76}{\kg}.

\item
  Hãy coi như vận tốc cuối khi Người nhện rơi là \SI{60}{\meter\per\second}.
\index{vận tốc cuối: terminal velocity}

\item
  Chiều dài sợi tơ là \SI{100}{\meter}.

\item
  Góc ban đầu của sợi tơ là \SI{45}{\degree} chúc xuống phía trái.

\item
  Hằng số lò xo của sợi tơ là \SI{40}{\newton\per\meter} khi sợi được kéo giãn, và bằng 0 khi bị ép nén.

\end{enumerate}

Trong kho mã lệnh kèm theo cuốn sách này, bạn sẽ thấy cuốn sổ lệnh, \py{spiderman.ipynb}, trong đó chứa mã lệnh khởi đầu. Hãy đọc qua cuốn sổ một lượt rồi chạy mã lệnh. Trong mã lệnh có dùng \py{minimize}, đây là một hàm SciPy nhằm tìm kiếm một tập hợp tham số tối ưu (khác hẳn \py{min_bounded}, vốn chỉ tìm kiếm dọc theo một trục thôi).


\section{Mèo con}

Ta hãy cùng mô phỏng con mèo tháo cuộn giấy vệ sinh.  Video này cho thấy tài liệu tham khảo: \url{http://modsimpy.com/kitten}.

\index{mèo con: kitten}

Tương tác giữa chú mèo con và cuộn giấy thì rất phức tạp. Để đơn giản, ta hãy giửa sử rằng mèo sẽ kéo đầu cuộn giấy xuống với lực không đổi. Ngoài ra, ta cũng bỏ qua ma sát giữa cuộn giấy và trục.

\begin{figure}
\centerline{\includegraphics[height=2.5in]{figs/kitten.pdf}}
\caption{Sơ đồ cuộn giấy vệ sinh, cho thấy lực tác dụng, tay đòn, và mô-men xoắn phát sinh.}
\label{kitten}
\end{figure}

Hình~\ref{kitten} cho thấy rằng cuộn giấy cùng với $r$, $F$, và $\tau$.  Là một đại lượng vec-tơ, hướng của $\tau$ là xuyên vào trang giấy, nhưng tạm thời bây giờ ta chỉ để tâm tới độ lớn mà thôi.

Sau đây là đối tượng \py{Params} cùng với những tham số ta cần:
...
Như trước đây, \py{Rmin} là bán kính trong còn \py{Rmax} là bán kính ngoài.  \py{L}  là chiều dài cuộn giấy.  \py{Mcore} là khối lượng của ống bìa giữa cuộn;  \py{Mroll} là khối lượng giấy.  \py{tension} là lực tác dụng bởi mèo con, tính theo \si{\newton}.  Tôi chọn một giá trị để cho kết quả hợp lý.

Trên web \url{http://modsimpy.com/moment} bạn có thể tra tìm mô-men quán tính cho các vật thể có hình dạng đơn giản. Tôi sẽ mô hình hoá lõi ống bìa giữa cuộn giấy như một vỏ trụ mỏng (``thin cylindrical shell"), còn cuộn giấy như một ống trụ thành dày có hai đầu hở (``thick-walled cylindrical tube with open ends").

\index{hình trụ: cylinder}

Mô-men quán tính của vỏ trụ mỏng đơn giản là $m r^2$, trong đó $m$ là khối lượng còn $r$ là bán kính vỏ trụ này.

Với ống trụ thành dày, mô-men quán tính là
%
\[ I = \frac{\pi \rho h}{2} (r_2^4 - r_1^4) \]
%
trong đó $\rho$ là mật độ vật liệu, $h$ là chiều cao ống, $r_2$ là bán kính ngoài, còn $r_1$ là bán kính trong.

Vì bán kính ngoài sẽ thay đổi trong khi mèo con tháo cuộn giấy, nên tại mỗi thời điểm, ta phải đi tính mô-men quán tính dưới dạng hàm của bán kín hiện thời, \py{r}.  Sau đây là một hàm thực hiện nhiệm vụ này:
...
\py{rho_h} là tích của mật độ và chiều cao, $\rho h$, vốn là khối lượng trên mỗi đơn vị diện tích.  \py{rho_h} được tính trong \py{make_system}:
...
\py{make_system} cũng tính ra \py{k} theo PT~\ref{eqn4}.

Trong kho mã lệnh kèm theo cuốn sách này, bạn sẽ thấy cuốn sổ lệnh, \py{kitten.ipynb}, trong đó chứa mã lệnh khởi đầu cho nghiên cứu cụ thể này.  Hãy dùng nó để lập mô hình này rồi kiểm tra xem kết quả có hợp lý không.


\section{Mô phỏng trò chơi yo-yo}
...
Ta có thể tính gia tốc của yo-yo bằng cách cộng các lực dài:
%
\[ \sum F = T - mg = ma \]
%
Trong đó $T$ có giá trị dương vì lực căng hướng lên, còn $mg$ thì âm vì trọng lực hướng xuống dưới.

Vì trọng lực tác dụng lên khối tâm nên nó không tạo ra mô-men xoắn, bởi vậy mô-men xoắn chỉ do lực căng dây gây ra:
%
\[ \sum \tau = T r = I \alpha \]
%
Lực căng dương (hướng lên trên) gây ra gia tốc góc dương (ngược chiều kim đồng hồ).

\index{SymPy}

Bây giờ ta có ba phương trình chứa ba ẩn số, $T$, $a$, và $\alpha$, cùng với các đại lương đã biết gồm $I$, $m$, $g$, và $r$. Để giải phương trình này bằng cách thủ công thì cũng đơn giản, song ta có thể nhờ SymPy thực hiện giúp
...
\end{align*}
%
trong đó $I^*$ là mô-men mô men quán tính phụ trội, $I + m r^2$.
Để mô phỏng hệ thống, thực ra ta không cần đến $T$; chỉ cần thay $a$ và $\alpha$ trực tiếp vào hàm độ dốc.

Trong kho mã lệnh kèm theo cuốn sách này, bạn sẽ thấy cuốn sổ lệnh, \py{yoyo.ipynb}, trong đó chứa cách xây dựng những phương trình nêu trên cùng với mã lệnh khởi đầu nghiên cứu trường hợp này. Hãy dùng nó để thiết lập và kiểm thử mô hình.


%\section{Con lắc cứng}
...
% Bài toán cứng khi k tăng

% Bổ sung ma sát 

% Con lắc cứng: giải các ràng buộc
...
\section{Bên trong lớp vỏ bọc}

Xuyên suốt cuốn sách này, ta sẽ dùng các hàm định nghĩa trong thư viện \py{modsim}. Bạn không cần phải biết cách chúng hoạt động, nhưng cũng có thể tò mò đôi chút. Bởi vậy ở cuối một số chương, tôi sẽ dẫn ra thêm chút thông tin. Nếu bạn là lập trình viên có kinh nghiệm, bạn có thể quan tâm đến cách tôi lựa chọn thiết kế chương trình. Còn nếu là người mới học và tin tưởng rằng bạn được trao các công cụ trong tay rồi thì không cần phải xem chi tiết trong các mục này làm gì.

\index{modsim}

Hầu hết các hàm trong \py{modsim} đều dựa trên thư viện Python khác; những thư viện mà ta dùng cho đến giờ bao gồm:

\begin{itemize}

\item {\bf Pint}, thư viện này cung cấp các đơn vị như thời gian (giây), như ta đã thấy ở Mục~\ref{penny}.

\item {\bf NumPy}, thư viện này cung cấp các phép toán như \py{sqrt}, như ta đã thấy ở Mục~\ref{computation}.

\item {\bf Pandas}, thư viện này cung cấp đối tượng \py{Series}, vốn là cơ sở cho đối tượng \py{State} trong Mục~\ref{modeling}.

\item {\bf Pyplot}, thư viện này cung cấp các hàm vẽ biểu đồ, như ta đã thấy ở Mục~\ref{plotting}.

\end{itemize}

Bạn có thể trực tiếp dùng các thư viện kể trên, và khi tích luỹ kinh nghiệm thì có thể bạn sẽ nhất thiết dùng đến. Nhưng các hàm trong \py{modsim} được thiết kế với mục đích dễ sử dụng; chúng cung cấp thêm các tính năng khác, bao gồm soát lỗi; và ẩn giấu những chi tiêt mà bạn không cần biết, chúng giúp bạn tập trung vào những điều quan trọng hơn.

Tuy nhiên, vẫn có những hạn chế. Một trong số đó là, bạn có thể khó hiểu được những thông báo lỗi. Tôi sẽ còn nói về điều này trong những chương sau, nhưng lúc này tôi có một gợi ý. Khi bạn mới bắt đầu, nên thực hành việc mắc lỗi.

\index{gỡ lỗi: debug}

Với mỗi hàm mới học, bạn nên cố ý phạm phải càng nhiều lỗi càng tốt, để xem điều gì sẽ xảy ra. Khi bạn thấy những thông báo lỗi đưa ra như thế nào, bạn sẽ hiểu được ý nghĩa của chúng. Và điều này sẽ giúp bạn về sau khi bạn chẳng may phạm lỗi.
